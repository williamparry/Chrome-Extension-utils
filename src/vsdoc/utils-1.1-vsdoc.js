var UTILS = {
    ...
    PortMessenger: function () {
        ...
        this.sendMessage = function (portName, message, currentTab) {
            ...
            /// <param name="currentTab" type="chrome.tabs.Tab" optional="true">Tab to send to. If not supplied, will send to all.</param>
    ...
    XHR: {
        ...
        Manager: function (maxConnections) {

            /// <summary>Manager for xmlHttpRequests that ties in an event dispatcher</summary>
            /// <param name="maxConnections" type="Number" integer="true" optional="true">Maximum number of concurrent connections</param>
